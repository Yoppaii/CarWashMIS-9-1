...
{
    public partial class frmViewExtraLarge : Form
    {
        private string placeholderText = "Enter text here";

        public frmViewExtraLarge()
        {
            InitializeComponent();
            SetPlaceholder();
        ...
        private void frmViewExtraLarge_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'employee.M_VehicleList' table. You can move, or remove it, as needed.
            this.m_VehicleListTableAdapter.FillByXL(this.employee.M_VehicleList);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            }
            {
                ...
                {
                    this.m_VehicleListTableAdapter.FillBySearchXL(this.employee.M_VehicleList, txtSearch.Text);
