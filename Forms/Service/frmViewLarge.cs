...
{
    public partial class frmViewLarge : Form
    {
        ...
        private void frmViewLarge_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'employee.M_VehicleList' table. You can move, or remove it, as needed.
            this.m_VehicleListTableAdapter.FillByLarge(this.employee.M_VehicleList);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.m_VehicleListTableAdapter.FillBySearchL(this.employee.M_VehicleList, txtSearch.Text);
