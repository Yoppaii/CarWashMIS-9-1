...
{
    public partial class frmViewSmall : Form
    {
        ...
        private void frmViewSmall_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'employee.M_VehicleList' table. You can move, or remove it, as needed.
            this.m_VehicleListTableAdapter.FillBySmall(this.employee.M_VehicleList);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.m_VehicleListTableAdapter.FillBySearchS(this.employee.M_VehicleList, txtSearch.Text);
